...
srun --exclusive -p ampere -t 00:02:00 -A DIRAC-DT001-GPU nsys profile a.out 32    # Create a profile report of the code
...
```sh
srun --exclusive -p ampere -t 00:02:00 -A DIRAC-DT001-GPU ncu -k axpy_kernel a.out 32
```
